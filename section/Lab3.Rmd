...
```{r, echo=FALSE}
library(png)
include_graphics('lab3/conjugate.PNG')
include_graphics('lab3/common_distribution.PNG')
```
...
```{r, echo=FALSE}
include_graphics('lab3/pseudo_counts_1.png')
include_graphics('lab3/pseudo_counts_2.png')
```

* Poisson with gamma prior
```{r, echo=FALSE}
include_graphics('lab3/poisson_gamma.png')
```
