...
- Nectir for course related questions and discussion: https://app.nectir.io/group/ucsb/pstat-115-s23

- Gradescope: https://www.gradescope.com/courses/527725

- GauchoSpace: https://gauchospace.ucsb.edu/courses/course/view.php?id=55602
...
- You will typically have 2 weeks to complete the homeworks
...
- Use [http://shorturl.at/mSUV6](http://shorturl.at/mSUV6) to sync new material (BOOKMARK THIS)
...
```{r, out.width="30%"}
ig("images/woodpecker.jpg") ## example 1.2.2.1 reethinking


## measurement / observation , real or spurious, see rethinking book
## 2005 ornithologists at cornell calimed evidence of IBW, previously thought extinct
## see one, can reject the null
## disconfirmation: evidence is not always black and white
...
```{r, out.width="90%"}
ig("images/frequentist_flow_chart.png")
```
